...
const ai = new GoogleGenAI({ apiKey: "AIzaSyCxBy-9y4ic-mZJqD6USk_h_HDwdwTrD9s" });
...
async function Chatting(userProblem) {
  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      ...
      My name is Tanmay, I called her babu. I am a sports freak and love content craetion and good at coding . iam ms dhoni fan .
